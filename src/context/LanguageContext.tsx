...
const translations = {
  ...
  ai_greeting: {
    ...
    te: "నమస్కారం! నేను మీ TS Civic AI అసిస్టెంట్. నేను ఫిర్యాదు నమోదు, ట్రాకింగ్‌లో మీకు సహాయం చేయగలను మరియు మీ ప్రశ్నలక��� సమాధానాలు ఇవ్వగలను. ఈ రోజు నేను మీకు ఎలా సహాయం చేయగలను?",
  },
  ai_online_status: {
  ...
  ai_time_help: {
    ...
    hi: "समाधान का समय समस्या के प्रकार के अनु��ार अलग होता है: सड़कें (3-7 दिन), पानी (2-5 दिन), स्ट्रीट ला��ट (1-2 दिन), स्वच्छता (1-3 दिन)। पूरी प्रक्रिया के दौरान आपको SMS/ईमेल अपडेट मिलेंगे। क्या कोई विशेष प्रकार की समस्या है जिसके बारे में आप पूछ रहे हैं?",
  ...
  ai_contact_help: {
    ...
    hi: "आप सहायता से संपर्क कर सकते हैं: 📞 हेल्पलाइन: 1800-XXX-XXXX (24/7), 📧 ईमेल: support@tscivic.gov.in, 🏢 अपने स्थानीय नगरपालिका कार्यालय में जाएं, या तत्काल सहायता के लिए मुझसे चैट करना जारी रखें!",
  ...
  ai_thanks: {
    ...
    hi: "आपका स्वागत है! मैं TS Civic के बारे में किसी भी प्रश्न में मदद के लिए यहां हूं। शिकायत पंजीकरण, ट्रैकिंग, या किसी अन्य नागरिक सेवा के बारे में बेझिझक प��छें। क्या कुछ और है जो आप जानना चाहते हैं?",
