...
const translations = {
  ...
  multilingual_support_desc: {
    ...
    te: "వాయిస��-టు-టెక్స్ట్ మద్దతుతో తెలుగు, హిందీ మరియు ఇంగ్లీష్‌లో అందుబాటులో ఉంది",
  },
  ai_assistant: {
    en: "AI Assistant",
    hi: "AI सहायक",
  ...
  ai_location_help: {
    ...
    te: "లొకేషన్ కోసం: 1) ఆటోమేటిక్ GPS గుర్తింపు కోసం 'నా లొకేషన్' బటన్ ఉపయోగించండి, 2) లేదా మాన్యువల్‌గా మీ చిరునామా నమోద��� చేయండి, 3) మంచి గుర్తింపు కోసం సమీపంలోని ల్యాండ్‌మార్క్‌లను జోడించండి. ఖచ్చితమైన లొకేషన్ అధికారులకు సరైన ప్రదేశానికి త్వరగా చేరుకోవడంలో సహాయపడుతుంది.",
  },
  ai_contact_help: {
  ...
  ai_thanks: {
    ...
    hi: "आपका स्���ागत है! मैं TG Civic के बारे में किसी भी प्रश्न में मदद के लिए यहां हूं। शिकायत पंजीकरण, ट्रैकिंग, या किसी अन्य नागरिक सेवा के बारे में बेझिझक पूछें। क्या कुछ और है जो आप जानना चाहते हैं?",
  ...
  ai_emergency: {
    ...
    hi: "आपातकाल के लिए: 🚨 100 कॉल करें (पुलिस), 🚒 101 कॉल करें (फायर), 🚑 108 कॉल करें (एम्बुलेंस)। तत्काल नागरिक मुद्दों के लिए, एक शिकायत दर्ज करें और इसे 'उच्च प्���ाथमिकता' के रूप में चिह्नित करें। आपातकालीन शिकायतों को तुरंत संसाधित किया जाता है।",
