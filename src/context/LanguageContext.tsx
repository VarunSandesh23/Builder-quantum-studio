...
const translations = {
  ...
  ai_greeting: {
    en: "Hello! I'm your TS Civic AI assistant. I can help you with complaint registration, tracking, and answer your questions. How can I assist you today?",
    hi: "नमस्ते! मैं आपका TS Civic AI सहायक हूं। मैं शिकायत पंजीकरण, ट्रैकिंग में आपकी मदद कर सकता हूं और आपके प्रश्नों का उत्तर दे सकता हूं। आज मैं आपकी कैसे सहायता कर सकता हूं?",
    te: "నమస్కారం! నేను మీ TS Civic AI అసిస్టెంట్. నేను ఫిర్యాదు నమోదు, ట్రాకింగ్‌లో మీకు సహాయం చేయగలను మరియు మీ ప్రశ్నలకు సమాధానాలు ఇవ్వగలను. ఈ రోజు నేను మీకు ఎలా సహాయం చేయగలను?",
  },
  ai_online_status: {
  ...
  ai_track_help: {
    en: "To track your complaint: 1) Go to 'Track Complaint' page, 2) Enter your complaint ID (format: TSC2024XXXXXX) or phone number, 3) View complete status history and details. Do you have your complaint ID?",
    hi: "अपनी शिकायत को ट्रैक करने के लिए: 1) 'शिकायत ट्रैक करें' पेज पर जाएं, 2) अपना शिकायत ID (प्रारूप: TSC2024XXXXXX) या फोन नंबर दर्ज करें, 3) पूर्ण स्थिति इतिहास और विवरण देखें। क्या आपके पास अपना शिकायत ID है?",
    te: "మీ ఫిర్యాదును ట్రాక్ చేయడానికి: 1) 'ఫిర్యాదు ట్రాక్ చేయండి' పేజీకి వెళ్లండి, 2) మీ ఫిర్యాదు ID (ఫార్మాట్: TSC2024XXXXXX) లేదా ఫోన్ నంబర్ నమోదు చేయండి, 3) పూర్తి స్థితి చరిత్ర మరియు వివరాలను చూడండి. మీ దగ్గర మీ ఫిర్యాదు ID ఉందా?",
  },
  ai_time_help: {
  ...
  ai_location_help: {
    ...
    hi: "स्थान के लिए: 1) स्वचालित GPS खोज के लिए 'मेरा स्थान' बटन का उपयोग करें, 2) या मै��्युअल रूप से अपना पता दर्ज करें, 3) बेहतर पहचान के लिए आस-पास के स्थलचिह्न जोड़ें। सटीक स्थान अधिकारियों को सही जगह जल्दी पहुंचने में मदद करता है।",
    te: "లొకేషన్ కోసం: 1) ఆటోమేటిక్ GPS గుర్తింపు కోసం 'నా లొకేషన్' బటన్ ఉపయోగించండి, 2) లేదా మాన్యువల్‌గా మీ చిరునామా నమోదు చేయండి, 3) మంచి గుర్తింపు కోసం సమీపంలోని ల్యాండ్‌మార్క్‌లను జోడించండి. ఖచ్చితమైన లొకేషన్ అధికారులకు సరైన ప్రదేశానికి త్వరగా చేరుకోవడంలో సహాయపడుతుంది.",
  },
  ai_contact_help: {
    en: "You can contact support: 📞 Helpline: 1800-XXX-XXXX (24/7), 📧 Email: support@tscivic.gov.in, 🏢 Visit your local municipal office, or continue chatting with me for immediate help!",
    hi: "आप सहायता स�� संपर्क कर सकते हैं: 📞 हेल्पलाइन: 1800-XXX-XXXX (24/7), 📧 ईमेल: support@tscivic.gov.in, 🏢 अपने स्थानीय नगरपालिका कार्यालय में जाएं, या तत्काल सहायता के लिए मुझसे चैट करना जारी रखें!",
    te: "మీరు మద్దతును సంప్రదించవచ్చు: 📞 హెల్ప్‌లైన్: 1800-XXX-XXXX (24/7), 📧 ఇమెయిల్: support@tscivic.gov.in, 🏢 మీ స్థానిక మునిసిపల్ కార్యాలయాన్ని సందర్శించండి, లేదా తక్షణ సహాయం కోసం నాతో చాట్ చేయడం కొనసాగించండి!",
  },
  ai_thanks: {
    en: "You're welcome! I'm here to help with any questions about TS Civic. Feel free to ask about complaint registration, tracking, or any other civic services. Is there anything else you'd like to know?",
    hi: "आपका स्वागत है! मैं TS Civic के बारे में किसी भी प्रश्न में मदद के लिए यहां हूं। शिकायत पंजीकरण, ट्रैकिंग, या किसी अन्य नागरिक सेवा के बारे में बेझिझक पूछें। क्या कुछ और है जो आप जानना चाहते हैं?",
    te: "మీకు స్వాగతం! TS Civic గురించి ఏవైనా ప్రశ్నలతో సహాయం చేయడానికి నేను ఇక్కడ ఉన్నాను. ఫిర్యాదు నమోదు, ట్రాకింగ్ లేదా ఏవైనా ఇతర పౌర సేవల గురించి అడగడానికి వెనుకాడకండి. మీరు తెలుసుకోవాలని అనుకునే ఇంకేమైనా ఉందా?",
  },
  ai_emergency: {
  ...
  ai_default: {
    ...
    hi: "मैं खुशी से मदद करूंगा! मैं आपकी सहायता कर ��कता हूं: 1) शिकायतें दर्ज करना, 2) शिकायत की स्थिति ट्रैक करना, 3) समाधान प्रक्रिया को समझना, 4) तकनीकी सहायता। क्या आप कृपया अधिक विशिष्ट बता सकते हैं कि आपको किस चीज़ में मदद चाहिए?",
